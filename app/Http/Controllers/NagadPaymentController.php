...
class NagadPaymentController extends Controller
{
    ...
    public function pay($amount) {
        ...
        $amount = $amount;
        $OrderId = 'NRB'.strtotime("now").rand(1000, 10000);
        ...
        $merchantCallbackURL = route('callback.url');
        ...
        $PostData = array(
            'accountNumber' => '01810198960', //Replace with Merchant Number (not mandatory)
            'dateTime' => $DateTime,
        ...
        if (isset($Result_Data['sensitiveData']) && isset($Result_Data['signature'])) {
            if ($Result_Data['sensitiveData'] != "" && $Result_Data['signature'] != "") {
                ...
                if (isset($PlainResponse['paymentReferenceId']) && isset($PlainResponse['challenge'])) {
                    ...
                    $logo = "https://garibook.com/dashboard/assets/Images/top-nav-logo.svg";
